            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Connect with researchers and other patients to share experiences.
                    </p>
                </div>
                <div className="flex items-center gap-2">
                    <Button variant="outline" onClick={() => window.location.href = '/dashboard/patient/collaborations'}>
                        Manage Connections
                    </Button>
                </div>
            </div>
                            ...
                            <Card key={user._id} className="flex flex-col">
                                ...
                                <CardFooter className="pt-2">
                                    {user.connectionStatus === 'connected' ? (
                                        <Button className="w-full" variant="outline" onClick={() => toast.info('Messaging feature coming soon!')}>
                                        ...
                                        isSending ? (
                                            ...
                                            <div className="flex space-x-2">
                                                <Button className="w-full" variant="default" onClick={() => window.location.href = '/dashboard/patient/collaborations'}>
